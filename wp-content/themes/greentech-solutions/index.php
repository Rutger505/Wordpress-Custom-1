    ...
    <div id="main">
        ...
        <article class="post">
            ...
            <a href="single.html" class="image featured"><img
                        src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/pic01.jpg" alt=""/></a>
        ...
        <article class="post">
            ...
            <a href="single.html" class="image featured"><img
                        src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/pic02.jpg" alt=""/></a>
            <p>Mauris neque quam, fermentum ut nisl vitae, convallis maximus nisl. Sed mattis nunc id lorem euismod
                placerat. Vivamus porttitor magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies mi non
        ...
        <article class="post">
            ...
            <a href="single.html" class="image featured"><img
                        src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/pic03.jpg" alt=""/></a>
            <p>Mauris neque quam, fermentum ut nisl vitae, convallis maximus nisl. Sed mattis nunc id lorem euismod
                placerat. Vivamus porttitor magna enim, ac accumsan tortor cursus at. Phasellus sed ultricies mi non
                congue ullam corper. Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus
